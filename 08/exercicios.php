...
echo "Desafio 1: Contagem Regressiva <br><br>";

// Solução com for
echo "<b>Exemplo 1: Solução com FOR</b> <br>";
for ($i = $numero; $i >= 0; $i--) {
...
// Solução com while
echo "<b>Exemplo 2: Solução com WHILE </b><br>";
$i = $numero;
while ($i >= 0) {
    echo "Faltam $i segundos <br>";
    $i--;   
...
echo "<b>Exemplo 3: Solução com DO-WHILE </b><br>";
$i = $numero;
do { 
    echo "Faltam $i segundos <br>";
    $i--;
...
$contagem = 10;
for ($i = 0; $i <= 10; $i++) {
    echo "$i X $tabuada_numero = " . $i*$tabuada_numero . "<br>";
}
echo "<br>";
...
*/
echo "Desafio 3: Sequência Fibonacci <br><br>";
...
// Implementação de Ordenação de Números
    ...
    foreach ($numeros as $numero) {
        echo "// Implementação de Verificação de Palíndromo
        $numero ";
    }
    echo "<br>";
